...
** Aula 5 - Introdução aos mandamentos e 4o mandamento
*** Item                                                            :drill:
...
Nota: mandamentos listados em ordem [decrescente||"crescente" or "decrescente"] de importância.
...
- Necessidade extrema :: além de ser grave, o indivíduo [não
  pode||"pode" or "não pode"] se defender sozinho
...
- Durante a heucaristia, o pão se transforma no corpo físico de crito
  resuscitado (está na hóstia o cristo inteiro). Assim também com o
  vinho.
- A presença do Cristo na heucaristia de desfaz quando a o pão/vinho
