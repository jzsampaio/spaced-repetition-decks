...
> I) Alguns As não são Bs (original)

> II) Alguns não-Bs não são não-As (proposição que queremos avaliar se
é convertível na original)

Aplicando 2.1 a II temos:

> III) Alguns não-Bs são As (equivalente a II)

Aplicando 2.2 a I temos:

> IV)  Alguns As são não-Bs (equivalente a I)

Aplicando-se 1 a IV) temos:

> V) Alguns não-Bs são As
...
Remove-se o nem, e troca-se a quantidade e a qualidade. Obtem-se:
