...
:ID:       034b0d81-dc7a-4fe4-b603-5edaed9db2eb
:END:

Dentre as 6 principais propriedades do termo:

- Amplicação :: é a extensão do termo de uma significação menor a uma
  outra maior. E.g.: bem-aventurados os mansos, porque possuirão a
  terra.
- Restrição :: é a restrição do termo de uma significação maior a uma
